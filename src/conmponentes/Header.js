...
function Header() {
  return (
    <>
      ...
      <button className="btn btn-secondary dropdown-toggle bg-transparent border-0 gap-15 align-items-between" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
        <span className="me-5 d-inline-block"><TbCategory2 className="img1"/>  shop categorie</span>
      </button>
